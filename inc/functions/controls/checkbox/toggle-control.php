...
if ( ! class_exists( 'Customizer_Toggle_Control' ) ) {
	...
	class Customizer_Toggle_Control extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_script( 'customizer-toggle-control', esc_url( get_stylesheet_directory_uri() . '/inc/functions/controls/checkbox/js/customizer-toggle-control.js' ), array( 'jquery' ), true );
			// wp_enqueue_style( 'pure-css-toggle-buttons', get_stylesheet_directory_uri( 'pure-css-togle-buttons.css', __FILE__ ), array() );
			wp_enqueue_style( 'ios-style', esc_url( get_stylesheet_directory_uri() . '/inc/functions/controls/checkbox/pure-css-togle-buttons.css' ) );
			$css = '
